...
MAX_VISUAL_EVENT_FALLBACK_FRAMES = int(
    os.environ.get("MAX_VISUAL_EVENT_FALLBACK_FRAMES", "2")
)
VISUAL_EVENT_WINDOW_RADIUS_FRAMES = int(
    os.environ.get("VISUAL_EVENT_WINDOW_RADIUS_FRAMES", "2")
)
MAX_FRAME_ANALYSIS_WORKERS = int(os.environ.get("MAX_FRAME_ANALYSIS_WORKERS", "4"))
